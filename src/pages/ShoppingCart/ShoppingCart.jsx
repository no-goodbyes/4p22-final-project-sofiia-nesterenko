    ...
    return (
        <div>
            ...
            <Container className=" shopping-cart__products d-flex card-container">
            {
                ...
                <Container className="d-flex flex-row shopping-cart__button-container">
                <Button onClick={() => dispatch(clearBasket())} className="shopping-cart__button">Очистить корзину</Button>
